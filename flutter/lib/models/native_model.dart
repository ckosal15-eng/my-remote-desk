...
class PlatformFFI {
  ...
  late MyremotedeskImpl _ffiBind;
  ...
  MyremotedeskImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _ffiBind = MyremotedeskImpl(dylib);
  ...
  void _startListenEvent(MyremotedeskImpl rustdeskImpl) {
    final appType =
